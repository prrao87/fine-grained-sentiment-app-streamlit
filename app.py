...
n_samples = st.text_input('Number of samples to generate for LIME explainer: (For really long input text, go up to 5000)', value=5000)
...
if st.button("Explain Results"):
    with st.spinner('Calculating...'):
        ...
        components.html(exp.as_html(), height=1000)
